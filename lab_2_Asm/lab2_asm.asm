...
;максимальная задержка составляет 195848 тактов,
;что при частоте 8Мгц составляет примерно 24.5мс
